...
```{r 512, echo=F, out.width = '75%',fig.align='center',message=F,warning=F,fig.cap="标准化总成绩的密度直方图",fig.asp = 0.75}
...
```{r 3, echo=F, fig.cap="吴迪雅10161170121", out.width = '35%',fig.align='center'}
