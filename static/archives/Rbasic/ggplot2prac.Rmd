...
一个有用的链接：
<http://rpubs.com/faststar/442420>
...
ggplot(hatdt,aes(x=agem,y=inc,shape=type,color=type,weight=fswt_nat)) +
...
```{r,message = F, comment = NA, warning = F,cache = T,fig.align='center',out.width ='80%'} 
