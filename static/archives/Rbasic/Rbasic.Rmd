...
```{r a ,message = F, comment = NA,warning = F,include = T}
library(dplyr)
`%>%` <- magrittr::`%>%`
...
# 循环
`for`循环
```{r for ,message = F, comment = NA,warning = F, include = T}
...
```{r c ,message = F, comment = NA,warning = F, include = T}
stocks <- tibble(
...
```{r d,message = F, comment = NA,warning = F, include = T}
...
```{r e,message = F, comment = NA,warning = F, include = T}
...
```{r g,message = F, comment = NA,warning = F, include = T}
