...
```{r a ,message = F, comment = NA,warning = F}
library(dplyr)
`%>%` <- magrittr::`%>%`
...
# 循环
`for`循环
```{r for ,message = F, comment = NA,warning = F}
...
```{r c ,message = F, comment = NA,warning = F}
stocks <- tibble(
...
```{r d,message = F, comment = NA,warning = F}
...
```{r e,message = F, comment = NA,warning = F}
...
```{r g,message = F, comment = NA,warning = F,error=T}
