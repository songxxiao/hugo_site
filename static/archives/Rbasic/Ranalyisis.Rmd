...
```{r delta,message = F, comment = NA,warning = F,fig.align='center',out.width ='100%',fig.asp=0.7}
#葡萄酒数据
...
```{r a,message = F, comment = NA,warning = F,fig.align='center',out.width ='95%',fig.asp=0.7}
...
```{r b,message = F, comment = NA,warning = F,cache=T,fig.align='center',out.width ='100%',fig.asp=0.6}
...
```{r c,message = F, comment = NA,warning = F,cache=T,fig.align='center',out.width ='90%',fig.asp=0.8}
#数据:USJudgeRatings
...
```{r cars2,message = F, comment = NA,warning = F}
...
```{r cars3,message = F, comment = NA,warning = F}
...
```{r cars4,message = F, comment = NA,warning = F}
df <- data.frame(X = simulatedXandC[, 1],
...
```{r cars5,message = F, comment = NA,warning = F}
