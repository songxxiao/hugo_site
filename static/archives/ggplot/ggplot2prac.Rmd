...
```{r a ,message = F, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='100%',fig.asp=0.6}
library(ggplot2)
data(diamonds)
...
facet_wrap(~cut, nrow = 2)
```
```{r b ,message = F, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='80%',fig.asp=0.6}
library(haven)
...
```{r c,message = F, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='80%',fig.asp=0.6}
