...
# 学习资源<span style="color:white">a</span>
...
# 二维密度图<span style="color:white">b</span>
...
# 抽样散点图<span style="color:white">c</span>
...
# 模型可视化<span style="color:white">d</span>
...
## 分面<span style="color:white">e</span>
...
## 分组<span style="color:white">f</span>
...
# 地图绘制<span style="color:white">g</span>
...
# 数据长宽转换<span style="color:white">h</span>
...
## 气泡地图<span style="color:white">i</span>

```{r is,message = F, comment = NA, warning = F, include = T,cache = T,fig.align='center',out.width ='100%'} 
library(rgdal)
