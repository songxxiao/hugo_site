...
facet_wrap(~cut, nrow = 2)
```
```{r b ,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='80%',fig.asp=0.6}
library(haven)
...
```{r c,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='80%',fig.asp=0.6}
