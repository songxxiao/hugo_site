...
```{r,comment = NA,warning = F,message = F,fig.cap='过采样前',out.width='65%'}
...
```{r,comment = NA,warning = F,message = F,fig.align='center',fig.cap='过采样后',out.width='65%'}
#过采样
...
```{r,comment = NA,warning = F,message = F,fig.align='center',fig.cap='K值和准确率的关系',out.width='65%'}
...
```{r,eval=F,comment = NA,warning = F,message =F,fig.align='center',fig.cap='ROC曲线',out.width='65%'}
