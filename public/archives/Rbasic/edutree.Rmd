...
```{r a,message = F,comment = NA,warning = F,echo = T,fig.align='center',out.width ='100%',fig.cap='随机抽取30所学校的数学成绩差异'}
setwd("E:/edu/data2")
ceps <- read_dta("E:/edu/data2/ceps.dta")
#抽出30所学校，作成绩箱线图
ceps1 <- ceps %>% 
...
```{r re,message=F,comment=NA,warning=F,message = F, include = T}
#建立回归树
...
```{r s, fig=TRUE,pdf=TRUE,comment=NA,echo=T,warning=FALSE,out.width ='100%',fig.cap="总成绩的回归树",fig.align='center'}
tree$cptable #复杂度参数表
rpart.plot(tree)
```
...
```{r fig1,message = F, comment = NA,warning =F,include=T,fig.align='center',out.width ='100%',fig.cap='未剪枝的分类树'}
...
```{r fig5,message = F, comment = NA,warning = F, include = T,fig.align='center',out.width ='100%',fig.cap='剪枝后分类树'}
...
```{r fig6, message = F, comment = NA,warning = F,include = T,fig.align='center',out.width ='100%',fig.cap='剪枝后分类树的ROC曲线'}
...
```{r fig7,cached = T,message = F,comment = NA,warning=F,include=T,fig.align='center',out.width ='100%',fig.cap='训练后模型的ROC曲线和AUC值'}
...
```{r fig8,cached = T,message = F,comment = NA,warning=F,include=T,fig.align='center',out.width ='100%',fig.cap='分类树的复杂度参数与准确率的关系'}
...
```{r randomForest,message = F,comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='100%',fig.asp=1.2,fig.cap='变量重要性'}
