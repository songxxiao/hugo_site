...
ggplot(long, aes(long,lat,group = group,
...
earthquake <- read_csv("E:/MaLearning/earthquake20190630.csv",
...
era <- ggplot(df,aes(grp,fit,
                     ymin=fit-se,ymax=fit+se)) +
  geom_point()+
  geom_line()+
  geom_errorbar(width=0.3)

erb <- ggplot(df,aes(grp,fit,
                     ymin=fit-se,ymax=fit+se)) +
  geom_line()+
  geom_linerange()
  
erc <- ggplot(df,aes(grp,fit,
                     ymin=fit-se,ymax=fit+se)) +
  geom_line()+
