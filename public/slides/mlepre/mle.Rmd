...
---
``````{r 2, echo=F, fig.cap=" ", out.width = '55%',fig.align='center'}
...
```{r 512, echo=F, fig.cap=" ", out.width = '40%',fig.align='center',message=FALSE,warning=FALSE,fig.cap="标准化总成绩的密度直方图",fig.asp = 0.55}
...
```{r 3, echo=F, fig.cap=" ", out.width = '40%',fig.align='center'}
...
# Stata 命令
```{r 4, echo=F, fig.cap=" ", out.width = '45%',fig.align='center'}
