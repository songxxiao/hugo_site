...
class: center, middle
# 数据与变量
``````{r, echo=F, fig.cap=" ", out.width = '55%',fig.cap="姜昱竹 10171170149",fig.align='center'}
...
```{r, echo=F, out.width = '75%',fig.align='center',message=F,warning=F,fig.cap="收入对数的密度直方图",fig.asp = 0.75,dev='svg',fig.showtext=T}
library(haven)
library(lattice)
chip <- read_dta("F:/Mysite/Mysite/static/slides/mlepre/chip88.dta")
attach(chip)
histogram(logearn,equal.widths =T, nint = 70, xlab = '收入对数',type = 'density',ylab = '密度')
```
...
```{r, echo=F, fig.cap="吴迪雅 10161170121", out.width = '35%',fig.align='center'}
...
```{r, echo=F, fig.cap="<font color=#FF0000>各回归直线平行，斜率相同，截距随层2随机变化</font>", out.width = '70%',fig.align='center'}
...
```{r, echo=F, fig.cap="<font color=#FF0000>各回归直线的截距和斜率均随层2随机变化</font>", out.width = '70%',fig.align='center'}
...
# Stata 命令
```{r, echo=F, fig.cap="宋骁 10161170106", out.width = '35%',fig.align='center'}
...
# 谢谢!
```{r, echo=F, fig.cap=" ",out.width = '60%',fig.align='center'}
