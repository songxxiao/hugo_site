...
``````{r pressure, echo=F, fig.cap=" ", out.width = '60%'}
...
``````{r pressure2, echo=F, fig.cap=" ", out.width = '60%'}
...
``````{r pressure3, echo=F, fig.cap=" ", out.width = '60%'}
...
``````{r pressure4, echo=F, fig.cap=" ", out.width = '50%'}
