...
```{r sur22, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='MikTeX界面'}
...
```{r sur1, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='依次点击Tools - Global Options - Sweave配置Sweave环境'}
...
```{r spdf, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='点击Open File打开一个LaTeX文档'}
knitr::include_graphics("/img/sweave/cut.JPG")
```

打开后，可以直接在R Studio中进行编辑写作。完成后，点击上方Complie PDF编译LaTeX文档，如图：

```{r click, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='点击Complie PDF编译LaTeX文档'}
...
```{r click2, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='编译好的PDF文档'}
...
```{r type, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',fig.cap='Mathtype编辑器'}
...
R Sweave的主要功能并不是一个LaTeX编辑器，而是为了将R的运行结果嵌入PDF形成动态报告。等你能够成功地在R Sweave运行PDF时，嵌入代码就太简单了。R Markdown转换为PDF也是同样的道理。

方法很简单，新建一个R Sweave文档，然后在里面编辑LaTeX，之后运行就可以了。

```{r rnw, echo=F, fig.cap=" ", out.width = '30%',fig.align='center',fig.cap='新建一个R Sweave文档'}
