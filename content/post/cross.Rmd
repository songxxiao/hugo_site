...
```{r 4,comment = NA,warning = F,message = F, include = T,fig.align='center',fig.cap='K值和准确率的关系',out.width='65%'}
...
```{r 5,comment = NA,warning = F,message = F, include = T,fig.align='center',fig.cap='ROC曲线',out.width='65%'}
