...
```{r,comment = NA,warning = F,message = F,fig.align='center',fig.cap='K值和准确率的关系',out.width='100%'}
...
```{r,comment = NA,warning = F,message = F,fig.align='center',fig.cap='ROC曲线',out.width='100%'}
