...
```{r add ,message = F,prompt=T, comment = NA,warning = F,message = F,echo = FALSE,fig.align='center', out.width='100%'}
setwd("E:/edu/data2")
library(haven)
library(tidyverse)
library(rpart)
...
```{r a ,message = F,prompt=T, comment = NA,warning = F,message = F,echo = T,fig.align='center',out.width ='100%'}
setwd("E:/edu/data2")
ceps <- read_dta("E:/edu/data2/ceps.dta")
#抽出30所学校，作成绩箱线图
ceps1 <- ceps %>% 
...
```{r re,message = F,prompt=T, comment = NA,warning = F,message = F, include = T}
...
```{r c ,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='100%'}
...
```{r d ,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',out.width ='100%'}
...
```{r caret,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center'}
