...
```{r a ,message = F,prompt=T, comment = NA,warning = F,message = F, include = F,eval = F}
setwd("E:/edu/data2")
library(haven)
library(tidyverse)
...
```{r b ,message = F,prompt=T, comment = NA,warning = F,message = F, include = F,eval = F}
...
```{r c ,message = F,prompt=T, comment = NA,warning = F,message = F, include = F,eval = F}
