---
title: "鍒濅腑鐢熷涔犳垚缁╃殑褰卞搷鍥犵礌鈥斺€斿熀浜庡垎绫讳笌鍥炲綊鏍戠殑鏂规硶"
author: ' '
date: '2019-05-08'
slug: edutree
tags: R
...
```{r c ,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',fig.cap="ROC曲线"}
...
```{r d ,message = F,prompt=T, comment = NA,warning = F,message = F, include = T,fig.align='center',fig.cap="ROC曲线"}
