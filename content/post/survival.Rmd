...
```{r ,comment = NA,warning = F,message = F,fig.align='center',include = F}
...
```{r,comment = NA,warning = F,message = F,fig.align='center',out.width ='100%'}
table(cwg$event)
...
```{r, echo=F, fig.cap=" ", out.width = '100%',fig.align='center',error=T}
...
```{r,comment = NA,warning = F,message = F,fig.align='center',out.width ='70%'}
...
```{r,comment = NA,warning = F,message = F,fig.align='center',out.width ='100%',results='asis'}
stargazer(coxreg,
          title='Cox回归结果',
          header=F,no.space=T,
          type='html',align=T,
...
```{r,comment = NA,warning = F,message = F,fig.align='center',out.width ='100%',fig.cap='协变量作用如何随时间变化'}
