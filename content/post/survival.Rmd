...
```{r c,prompt=T, comment = NA,warning = F,message = F,fig.align='center',out.width ='100%'}
...
```{r cw,prompt=T, comment = NA,warning = F,message = F,fig.align='center',out.width ='100%'}
...
```{r cox, prompt=T, comment = NA,warning = F,message = F,fig.align='center',out.width ='100%'}
...
#### additive hazards model of Aalen

```{r areg, prompt=T, comment = NA,warning = F,message = F,fig.align='center',out.width ='100%'}
